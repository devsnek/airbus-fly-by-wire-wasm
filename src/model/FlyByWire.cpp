...
void FlyByWireModelClass::step()
{
  ...
  rtb_Limiterxi2 = rtb_Limiterxi + FlyByWire_P.Constant_Value_o;
  FlyByWire_DWork.Delay1_DSTATE = 1.0 / rtb_Limiterxi2 * (FlyByWire_P.Constant_Value_o - rtb_Limiterxi) *
    FlyByWire_DWork.Delay1_DSTATE + (rtb_GainTheta + FlyByWire_DWork.Delay_DSTATE_e) * (rtb_Limiterxi / rtb_Limiterxi2);
  ...
  u0 = rtb_Limiterxi - FlyByWire_DWork.Delay_DSTATE_ex;
  ...
  FlyByWire_DWork.Delay_DSTATE_ex += rtb_Limiterxi2;
  ...
  u0 = FlyByWire_B.flare_Theta_c_deg - FlyByWire_DWork.Delay_DSTATE_o;
  ...
  FlyByWire_DWork.Delay_DSTATE_o += rtb_Limiterxi2;
  ...
  u0 = Phi - FlyByWire_DWork.Delay_DSTATE_a;
  ...
  FlyByWire_DWork.Delay_DSTATE_a += rtb_Limiterxi2;
  if (FlyByWire_DWork.Delay_DSTATE_a <= rtb_Sum5) {
    ...
    if (FlyByWire_DWork.Delay_DSTATE_a >= rtb_Sum5) {
      rtb_Sum5 = FlyByWire_DWork.Delay_DSTATE_a;
    }
  }
  ...
  if (rtb_in_flare > FlyByWire_P.Switch_Threshold) {
    rtb_Limiterxi = (FlyByWire_DWork.Delay_DSTATE_o - rtb_GainTheta) * FlyByWire_P.Gain_Gain;
  ...
  rtb_Limiterxi = (rtb_Gain1_b - FlyByWire_DWork.Delay_DSTATE_f) / FlyByWire_U.in.time.dt + rtb_Limiterxi *
  ...
  if (FlyByWire_DWork.Delay_DSTATE_ex > FlyByWire_P.Saturation_UpperSat_i) {
    rtb_Limitereta = FlyByWire_P.Saturation_UpperSat_i;
  } else if (FlyByWire_DWork.Delay_DSTATE_ex < FlyByWire_P.Saturation_LowerSat_eo) {
    rtb_Limitereta = FlyByWire_P.Saturation_LowerSat_eo;
  } else {
    rtb_Limitereta = FlyByWire_DWork.Delay_DSTATE_ex;
  }

  rtb_Sum5 = FlyByWire_DWork.Delay_DSTATE_f1 * rtb_Limitereta;
  rtb_Limitereta = FlyByWire_P.Constant_Value_k - rtb_Limitereta;
  ...
  u0 = FlyByWire_DWork.Delay_DSTATE_m - FlyByWire_DWork.Delay_DSTATE_j;
  ...
  FlyByWire_DWork.Delay_DSTATE_j += rtb_Limiterxi2;
  ...
  u0 = rtb_BusAssignment_a_sim_input_delta_zeta_pos - FlyByWire_DWork.Delay_DSTATE_p;
  ...
  FlyByWire_DWork.Delay_DSTATE_p += u1;
  ...
  rtb_Limiterxi = (FlyByWire_P.Gain5_Gain * FlyByWire_DWork.Delay_DSTATE_p + u0) * FlyByWire_DWork.Delay_DSTATE_l +
    rtb_Limiterxi2;
  ...
  if (FlyByWire_DWork.Delay_DSTATE_l > FlyByWire_P.Saturation_UpperSat_ll) {
    rtb_Limitereta = FlyByWire_P.Saturation_UpperSat_ll;
  } else if (FlyByWire_DWork.Delay_DSTATE_l < FlyByWire_P.Saturation_LowerSat_ev) {
    rtb_Limitereta = FlyByWire_P.Saturation_LowerSat_ev;
  } else {
  ...
  } else if (FlyByWire_DWork.Delay_DSTATE_l < FlyByWire_P.Saturation_LowerSat_m) {
    rtb_Limitereta = FlyByWire_P.Saturation_LowerSat_m;
  } else {
    rtb_Limitereta = FlyByWire_DWork.Delay_DSTATE_l;
  }

  rtb_Limiterxi *= rtb_Limitereta;
  rtb_Limitereta = FlyByWire_P.Constant_Value_e - rtb_Limitereta;
  rtb_Limitereta *= BusAssignment_roll_data_computed_delta_zeta_deg;
  rtb_Limiterxi += rtb_Limitereta;
  u0 = rtb_BusAssignment_m_pitch_output_eta_deg - FlyByWire_DWork.Delay_DSTATE_i;
  ...
  FlyByWire_DWork.Delay_DSTATE_i += rtb_Limiterxi2;
  u0 = rtb_Sum5 - FlyByWire_DWork.Delay_DSTATE_b;
  ...
  u0 = rtb_Limiterxi - FlyByWire_DWork.Delay_DSTATE_mj;
  ...
  FlyByWire_DWork.Delay_DSTATE_mj += rtb_Limiterxi2;
  ...
  u0 = FlyByWire_P.Gaineta_Gain_d * FlyByWire_DWork.Delay_DSTATE_i;
  ...
  u0 = FlyByWire_P.GainiH_Gain * FlyByWire_DWork.Delay_DSTATE_j;
  ...
  u0 = FlyByWire_P.Gainxi_Gain_n * FlyByWire_DWork.Delay_DSTATE_b;
  ...
  u0 = FlyByWire_P.Gainxi1_Gain_e * FlyByWire_DWork.Delay_DSTATE_mj;
  ...
  FlyByWire_Y.out.pitch.data_computed.in_flight_gain = FlyByWire_DWork.Delay_DSTATE_ex;
  ...
  FlyByWire_Y.out.pitch.data_computed.flare_Theta_c_deg = FlyByWire_DWork.Delay_DSTATE_o;
  ...
  FlyByWire_Y.out.pitch.output.eta_trim_deg = FlyByWire_DWork.Delay_DSTATE_j;
  ...
  FlyByWire_DWork.Delay_DSTATE_e = rtb_GainTheta;
...
void FlyByWireModelClass::initialize()
{
  ...
  FlyByWire_DWork.Delay_DSTATE_e = FlyByWire_P.Delay_InitialCondition_e;
  FlyByWire_DWork.Delay1_DSTATE = FlyByWire_P.Delay1_InitialCondition;
  FlyByWire_DWork.Delay_DSTATE_ex = FlyByWire_P.RateLimiterVariableTs_InitialCondition;
  FlyByWire_DWork.Delay_DSTATE_o = FlyByWire_P.RateLimiterDynamicVariableTs_InitialCondition;
  FlyByWire_DWork.Delay_DSTATE_a = FlyByWire_P.RateLimiterVariableTs_InitialCondition_c;
  FlyByWire_DWork.Delay_DSTATE_f = FlyByWire_P.DiscreteDerivativeVariableTs_InitialCondition;
  FlyByWire_DWork.icLoad = 1U;
  FlyByWire_DWork.Delay_DSTATE_j = FlyByWire_P.RateLimiterDynamicVariableTs_InitialCondition_i;
  FlyByWire_DWork.icLoad_b = 1U;
  FlyByWire_DWork.Delay_DSTATE_l = FlyByWire_P.RateLimiterVariableTs_InitialCondition_f;
  FlyByWire_DWork.icLoad_m = 1U;
  FlyByWire_DWork.Delay_DSTATE_p = FlyByWire_P.RateLimiterVariableTs_InitialCondition_fc;
  ...
  FlyByWire_DWork.Delay_DSTATE_i = FlyByWire_P.RateLimitereta_InitialCondition;
  FlyByWire_DWork.Delay_DSTATE_b = FlyByWire_P.RateLimiterxi_InitialCondition;
  FlyByWire_DWork.Delay_DSTATE_mj = FlyByWire_P.RateLimiterzeta_InitialCondition;
