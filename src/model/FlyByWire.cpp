...
void FlyByWireModelClass::step()
{
  ...
  if ((FlyByWire_B.in_flight == 0.0) || (rtb_BusAssignment_a_sim_data_computed_tracking_mode_on != 0)) {
  ...
  if ((rtb_in_flight == 0) || (rtb_BusAssignment_a_sim_data_computed_tracking_mode_on != 0)) {
